...
export default function Place1() {
  return (
    <div>
      <section className="bg-gradient-to-br from-darkbrown via-brown to-darkbrown text-cream py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold mb-4 animate-hero-reveal" style={{ animationDelay: "400ms" }}>Yessy Place 1</h1>
      ...
      <section className="py-10 sm:py-14 bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal animation="fade-up" className="text-center mb-6 sm:mb-10">
            ...
            <p className="text-brown/60 text-sm sm:text-base">A glimpse inside Yessy Place 1</p>
          </ScrollReveal>
          ...
          <ScrollReveal animation="scale-in">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-square group">
                <Image
                  src="/cafe1%20(4).jpg"
                  alt="Yessy Place 1 food presentation"
                  fill
                  className="object-cover transition-transform duration-500 ease-out group-hover:scale-105"
                  sizes="(max-width: 640px) 50vw, 33vw"
                />
