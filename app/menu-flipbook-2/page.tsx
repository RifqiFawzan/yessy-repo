...
const tanjungBiasMenu: MenuSection[] = [
  ...
  },
  {
    category: "Local Food",
    items: [
      { name: "Ikan Bumbu Kuning", description: "Fish in yellow spice paste", price: "100K" },
      { name: "Cumi Goreng Tepung", description: "Fried calamari", price: "45K" },
      { name: "Udang Goreng Tepung", description: "Fried crispy shrimp", price: "45K" },
      { name: "Ayam Lalapan", description: "Fried chicken with fresh vegetables", price: "45K" },
      { name: "Capcay Seafood", description: "Stir-fried mixed vegetables with seafood", price: "35K" },
      { name: "Capcay Ayam", description: "Stir-fried mixed vegetables with chicken", price: "35K" },
      { name: "Pelecing", description: "Spicy water spinach salad", price: "20K" },
      { name: "Terong Bakar / Goreng", description: "Grilled or fried eggplant", price: "20K" },
      { name: "Tumis Kangkung", description: "Stir-fried water spinach", price: "25K" },
      { name: "Sayur Kelor", description: "Moringa leaf soup (Complete)", price: "25K" },
      { name: "Tahu / Tempe Goreng", description: "Fried tofu or tempeh", price: "20K" },
      { name: "Tempe Goreng Tepung", description: "Crispy batter-fried tempeh", price: "25K" },
      { name: "Telur Dadar", description: "Indonesian omelette", price: "20K" },
      { name: "Nasi Putih", description: "Steamed white rice", price: "10K" },
    ],
  },
  {
    category: "Nasi Goreng & Mie",
    items: [
      { name: "Nasi Goreng Telur", description: "Egg fried rice", price: "35K" },
      { name: "Nasi Goreng Terasi", description: "Shrimp paste fried rice", price: "35K" },
      { name: "Nasi Goreng Special", description: "Special fried rice", price: "35K" },
      { name: "Nasi Goreng Seafood", description: "Seafood fried rice", price: "35K" },
      { name: "Mie Goreng Special", description: "Special fried noodles", price: "35K" },
      { name: "Mie Goreng Seafood", description: "Seafood fried noodles", price: "35K" },
    ],
  },
  {
